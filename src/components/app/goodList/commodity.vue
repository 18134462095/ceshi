<template>
  <div class="commodity">
    <div class="lists" v-for="i in commodityList" :key="i.id" @click="toDetail(i)">
      <div class="img">
        <img :src="replaceHttp(i.pictUrl)" alt />
      </div>
      <div class="texts">
        <p class="title">{{i.title}}</p>
        <quan :quan="i.couponAmount" :fanli="i.memberForecastCommission"></quan>
        <div class="price">
          <p>到手￥</p>
